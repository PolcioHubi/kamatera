...
Revision ID: 8fbc61c37169
Revises: 
Create Date: 2025-08-21 14:01:34.557514
...
def upgrade():
    ...
    with op.batch_alter_table('access_keys', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_access_keys_is_active'), ['is_active'], unique=False)
    ...
    sa.Column('has_seen_tutorial', sa.Boolean(), nullable=False),
    ...
    with op.batch_alter_table('files', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_files_modified_at'), ['modified_at'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('files', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_files_modified_at'))
    ...
    with op.batch_alter_table('access_keys', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_access_keys_is_active'))
